REST, DTO. В этом проекте мы создаем две программы которые обмениваютя данными между собой с помощью REST API и data transfer object. Первое спринг приложение - это сервер, который хранит информацию о 
